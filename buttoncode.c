...
byte rowPins[NUMROWS] = {15,16,18,19,20}; //change "?" to the pins the rows of your button matrix are connected to
byte colPins[NUMCOLS] = {6,7,8,9,10,14}; //change "?" to the pins the rows of your button matrix are connected to
